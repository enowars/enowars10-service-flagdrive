        ...
        <nav class="sticky top-0 z-50 bg-white dark:bg-gov-bg-dark border-b border-neutral-200 dark:border-neutral-800 shadow-sm transition-colors duration-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center space-x-4 cursor-pointer" on:click=move |_| set_page.set(if is_logged_in() { Page::Dashboard } else { Page::Landing })>
                        ...
                        {move || if is_logged_in() {
                            view! {
                                ...
                                <button 
                                    ...
                                    on:click=move |_| set_page.set(Page::Landing)
                                >
                                    "Logout"
                                </button>
                            }.into_any()
